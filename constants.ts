...
export const MATERIAL_PALETTE: MaterialOption[] = [
  {
    ...
    description:
      'Exposed steel beams and columns with expressed joints. Available as painted (RAL colours) or exposed/galvanised finish.',
    keywords: ['steel', 'painted', 'expressed joints', 'frame'],
    category: 'structure',
    supportsColor: true,
    colorOptions: RAL_COLORS,
  ...
  {
    id: 'glulam-structure',
    name: 'Glulam (Beams + Columns)',
    tone: '#c49a6c',
    finish: 'Glulam timber beams and posts',
    description:
      'Laminated timber beams and columns forming a renewable, visually warm structural system with long-span capability. Typical uses: frames, long-span roofs, columns, portal structures.',
    keywords: ['timber', 'glulam', 'warm', 'frame', 'long-span', 'columns'],
    category: 'structure',
    carbonIntensity: 'low',
    materialType: 'timber',
  ...
  },
  {
    ...
    description:
      'Modular tubular steel space frame enabling long-span roofs and lightweight grids with high structural efficiency. Available painted (RAL) or exposed/galvanised finish.',
  ...
  },
  {
    ...
    description:
      'Mass timber CLT panels, prefabricated for rapid build, carbon storage, and excellent airtightness. Typical uses: load-bearing walls, floor slabs, roof decks.',
    keywords: ['timber', 'clt', 'mass timber', 'low carbon', 'walls', 'slabs', 'roofs'],
    category: 'structure',
    carbonIntensity: 'low',
    materialType: 'timber',
  ...
  },
  {
    ...
    description: 'Pick any wall colour and choose matte, satin, or gloss finish.',
  ...
  },
  {
    ...
    description: 'Define a custom ceiling colour with matte, satin, or gloss finish.',
  ...
  },
  {
    ...
    name: 'Load-Bearing Masonry (Brick)',
    tone: '#a8553c',
    ...
    keywords: ['brick', 'masonry', 'structure', 'walls'],
    category: 'structure',
    carbonIntensity: 'high',
    supportsColor: true,
    colorOptions: [
      { label: 'Red Multi', tone: '#a8553c' },
      { label: 'London Stock', tone: '#c9a86c' },
      { label: 'Staffordshire Blue', tone: '#4a5568' },
      { label: 'Buff', tone: '#d4b896' },
      { label: 'Yellow Stock', tone: '#d9c27e' },
      { label: 'Brown Brindle', tone: '#6b4423' },
      { label: 'White/Cream', tone: '#e8dcc8' }
    ],
    materialType: 'ceramic',
    materialForm: ['block'],
    materialFunction: ['structural'],
  ...
  },
  {
    ...
    name: 'Steel-Concrete Composite Deck',
    tone: '#b2b5b8',
    finish: 'Composite steel decking with concrete',
    description: 'Composite steel decking with concrete topping; efficient long-span solution. Steel deck available painted (RAL) or exposed.',
    keywords: ['composite', 'steel', 'concrete', 'structure', 'deck'],
    category: 'structure',
    supportsColor: true,
    colorOptions: RAL_COLORS,
    carbonIntensity: 'high',
  ...
  },
  {
    ...
    description: 'Long-span steel trusses for efficient roof and floor structures. Available painted (RAL) or exposed/galvanised finish.',
    keywords: ['steel', 'trusses', 'structure', 'long-span'],
    category: 'structure',
    supportsColor: true,
    colorOptions: RAL_COLORS,
    carbonIntensity: 'high',

...
export const MATERIAL_PALETTE: MaterialOption[] = [
  ...
  },
  {
    ...
    description: 'Warm textured cork wallcovering for hospitality and residential interiors, supporting acoustic softening and biophilic character.',
  ...
  },
  {
    ...
    description: 'Architectural veneer wall panels delivering warm grain and premium detailing for reception, hospitality, and residential interiors.',
  ...
  },
  {
    ...
    description: 'Thin build-up continuous finish using reduced-cement or lime-enhanced binders for walls and low-traffic interior floors.',
  ...
  },
  {
    ...
    description: 'Durable modular kitchen cabinetry using certified timber products with replaceable fronts and hardware for long service life.',
  ...
  },
  {
    ...
    description: 'Lightweight autoclaved aerated concrete blockwork for low-rise structure and infill where thermal performance and speed of installation are priorities.',
  ...
  },
  {
    ...
    description: 'Prefinished aluminium cladding panels; lightweight, corrosion-resistant, and available in many RAL colours.',
    keywords: ['facade', 'aluminium', 'cladding', 'metal', 'external'],
    category: 'external',
    treePaths: ['Envelope>Facade'],
    carbonIntensity: 'high'
  },
  {
    ...
    description: 'Standing seam aluminium roof with factory finish; lightweight, corrosion-resistant, and available in many RAL colours.',
  ...
  },
  {
    ...
    description: 'Tapware, shower controls, and bathroom accessories in brushed stainless steel for high durability and corrosion resistance.',
  ...
  },
  {
    ...
    description: 'Classic glazed ceramic tiles for kitchen splashbacks and bathroom walls, offering durable low-maintenance hygiene surfaces.',
  ...
  },
  {
    ...
    name: 'Load-Bearing Masonry (Concrete Block)',
    tone: '#9a9590',
    finish: 'Concrete blockwork',
    description: 'Concrete block load-bearing construction; cost-effective, fire-resistant, and thermally massive.',
    keywords: ['concrete', 'block', 'masonry', 'structure', 'walls'],
    category: 'structure',
    carbonIntensity: 'high'
  },
  {
  ...
  },
  {
    ...
    description: 'Minimal-framed or frameless glazed shower enclosures that maximise light transfer and visual openness in bathroom design.',
  ...
  },
  {
    ...
    description: 'Machined MDF joinery for cabinetry and wall lining systems, suitable for painted or veneered interiors with precise detailing.',
  ...
  },
  {
    ...
    description: 'Concrete mix using alkali-activated binders and industrial by-products to reduce clinker demand for structural and precast applications.',
  ...
  },
  {
    ...
    description: 'Green oak posts, beams, and braces with traditional carpentry joints; robust bio-based structure with strong carbon storage potential.',
  ...
  },
  {
    ...
    description: 'External wall insulation with reinforced render finish; Sto-type system with full RAL colour range.',
  ...
  },
  {
    ...
    description: 'Woven linen wallcovering that adds depth and softness to workplace and hospitality interiors with a natural tactile finish.',
  ...
  },
  {
    ...
    description: 'Cabinetry fronts and feature joinery faced in natural linoleum, offering a matte tactile finish with durable anti-fingerprint performance.',
  ...
  },
  {
    ...
    description: 'Low-flow shower heads and mixers designed to reduce potable water and hot-water energy demand in bathrooms and hotels.',
  ...
  },
  {
    ...
    description: 'Acoustic wall and ceiling panels formed from recycled PET felt, used for reverberation control in offices, schools, and social spaces.',
  ...
  },
  {
    ...
    description: 'Dense porcelain tiles for bathroom and kitchen wet zones, combining low water absorption with robust slip resistance and easy cleaning.',
  ...
  },
  {
    ...
    description: 'Engineered quartz worktops with high abrasion resistance and low porosity for kitchens, washrooms, and high-use hospitality counters.',
  ...
  },
  {
    ...
    description: 'Small-format mosaic tiles made with high recycled glass content, ideal for splashbacks, wet areas, and feature walls.',
  ...
  },
  {
    ...
    description: 'Back-painted or clear toughened glass splashback panels for kitchens and vanity zones with high hygiene and reflectivity.',
  ...
  },
  {
    ...
    description: 'Dense paper-composite surfaces for vanity tops and dry-use kitchen zones, delivering matte warmth with high recycled fibre content.',
  ...
  },
  {
    ...
    description: 'Loose furniture manufactured from recycled polymers for cafes, breakout spaces, and flexible learning or workplace environments.',
  ...
  },
  {
    ...
    description: 'Toilets and basins in vitreous ceramic with durable glazed surfaces for hygiene-critical bathroom and hospitality settings.',
  ...
  },
  {
    ...
    description: 'Ultra-compact mineral worktop surface for kitchens and bathrooms with high heat resistance, low porosity, and scratch durability.',
  ...
  },
  {
    ...
    description: 'Seamless thermoformable worktop material for healthcare, workplace kitchens, and washroom counters requiring hygienic detailing.',
  ...
  },
  {
    ...
    description: 'Modular tubular steel space frame enabling long-span roofs and lightweight grids with high structural efficiency.',
  ...
  },
  {
    ...
    description: 'Commercial-grade stainless steel worksurfaces for kitchens and utility spaces requiring high hygiene and chemical resistance.',
  ...
  },
  {
    ...
    description: 'Bio-based insulation boards from agricultural straw for walls and roofs, supporting moisture-buffering and low-embodied-carbon envelope design.',
  ...
  },
  {
    ...
    description: 'Vanity and storage joinery designed for humid bathroom environments with sealed edge protection and service access.',
  ...
  },
  {
    ...
    description: 'Wood wool acoustic boards with mineral binder for robust wall or ceiling absorption in civic, education, and retrofit projects.',
  ...
  },
  {
    ...
    description: 'Handcrafted zellige tiles with tonal variation and reflective glaze, suited to boutique hospitality, bathrooms, and statement joinery fronts.',

...
const SustainabilityBriefingSection: React.FC<SustainabilityBriefingSectionProps> = ({
  ...
  return (
    <div
      ...
      className="sustainability-briefing border border-gray-200 bg-white animate-fadeIn"
      style={{
        animation: sustainabilityBriefing && !isBriefingLoading ? 'fadeIn 0.3s ease-in' : 'none'
      }}
    >
